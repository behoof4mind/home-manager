...
wk.add({
  ...
  { "<leader>Op", group = "PR" },
  { "<leader>Opn", "<cmd>Octo pr create draft<CR>", desc = "Create draft", mode = "n" },
  ...
  { "<leader>OpR", "<cmd>Octo pr reload<CR>", desc = "Reload", mode = "n" },
  { "<leader>Opx", "<cmd>Octo pr close<CR>", desc = "Close", mode = "n" },
  ...
  -- Jira group
  { "<leader>j", group = "Jira" },
  { "<leader>jk", "<cmd>JiraKanban PT-board<cr>", desc = "Open Kanban board (PIE)", mode = "n" },
  { "<leader>jK", "<cmd>JiraKanban 3-rd-level-support<cr>", desc = "Open Kanban board (PIE+Support)", mode = "n" },
  { "<leader>jm", "<cmd>JiraMyIssuesPicker<cr>", desc = "My issues", mode = "n" },
  { "<leader>js", "<cmd>JiraSearchTitle<cr>", desc = "Search issue by title", mode = "n" },
  { "<leader>jS", "<cmd>JiraMyIssuesAll<cr>", desc = "Search in all my issues", mode = "n" },
