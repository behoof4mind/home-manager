...

{
  ...
  "${XDG_PATH}/markdownlint/markdownlint-cli2.yaml".source =
    ../apps-configs/neovim/markdownlint-cli2.yaml;
  ...
  "${XDG_PATH}/nvim/lua/plugins/sourcegraph.lua".source =
    ../apps-configs/neovim/lua/plugins/sourcegraph.lua;
  "${XDG_PATH}/nvim/lua/plugins/terminal.lua".source =
    ../apps-configs/neovim/lua/plugins/terminal.lua;
