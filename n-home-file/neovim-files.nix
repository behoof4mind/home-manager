...

{
  ...
  "${XDG_PATH}/nvim/lua/config/autocmds.lua".source =
    ../apps-configs/neovim/lua/config/autocmds.lua;
  "${XDG_PATH}/nvim/lua/config/keymaps.lua".source =
    ../apps-configs/neovim/lua/config/keymaps.lua;
  "${XDG_PATH}/nvim/lua/config/lazy.lua".source =
    ../apps-configs/neovim/lua/config/lazy.lua;
  "${XDG_PATH}/lazygit/config.yml".source =
    ../apps-configs/neovim/lazygit_config.yml;
  "${XDG_PATH}/nvim/lua/config/options.lua".source =
  ...
  "${XDG_PATH}/nvim/lua/plugins/coding.lua".source =
    ../apps-configs/neovim/lua/plugins/coding.lua;
  "${XDG_PATH}/nvim/lua/plugins/lsp.lua".source =
  ...
  "${XDG_PATH}/nvim/lua/plugins/lang/terraform.lua".source =
    ../apps-configs/neovim/lua/plugins/lang/terraform.lua;
  "${XDG_PATH}/nvim/lua/plugins/lang/yaml.lua".source =
    ../apps-configs/neovim/lua/plugins/lang/yaml.lua;
  "${XDG_PATH}/nvim/lua/plugins/copilot.lua".source =
    ../apps-configs/neovim/lua/plugins/copilot.lua;
  "${XDG_PATH}/nvim/lua/plugins/lualine.lua".source =
    ../apps-configs/neovim/lua/plugins/lualine.lua;
  "${XDG_PATH}/nvim/lua/plugins/lang/docker.lua".source =
    ../apps-configs/neovim/lua/plugins/lang/docker.lua;
  "${XDG_PATH}/nvim/lua/plugins/lang/markdown.lua".source =
    ../apps-configs/neovim/lua/plugins/lang/markdown.lua;
  "${XDG_PATH}/nvim/lua/plugins/lang/java.lua".source =
    ../apps-configs/neovim/lua/plugins/lang/java.lua;
  "${XDG_PATH}/nvim/lua/plugins/lang/json.lua".source =
  ...
  "${XDG_PATH}/nvim/lua/plugins/file-editor.lua".source =
    ../apps-configs/neovim/lua/plugins/file-editor.lua;
  "${XDG_PATH}/nvim/lua/plugins/git.lua".source =
