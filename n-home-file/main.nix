...
in
{
  ...
  "${builtins.getEnv "HOME"}/Library/Application Support/Code/User/keybindings.json".source =
    ../apps-configs/vscode/keybindings.json;
  "${builtins.getEnv "HOME"}/Library/Application\ Support/iTerm2/DynamicProfiles/Profiles.json".source =
    ../apps-configs/iterm2/DynamicProfiles/Profiles.json;
}
// neovimFiles
// k9sFiles
